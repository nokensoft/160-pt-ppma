                        ...
                        @forelse ($beritaList as $b)
                            <article class="bg-white shadow-card card-hover border border-neutral-100 fade-in">
                                ...
                                <div class="p-5">
                                    ...
                                    <a href="{{ route('berita.detail', $b->slug) }}" class="text-secondary text-lg font-semibold hover:text-secondary">
                                        Baca Selengkapnya <i class="fa-solid fa-arrow-right text-lg ml-1"></i>
                                    </a>
                                </div>
                            </article>
                        @empty
                        ...
                        <form method="GET" action="{{ $kategoriAktif ? route('berita.kategori', $kategoriAktif->slug) : route('berita') }}">
                            <div class="relative">
                                <input type="text" name="cari" value="{{ request('cari') }}" placeholder="Cari berita..."
                                       class="w-full border border-neutral-300 p-3 pr-10 text-lg focus:border-primary-400 focus:outline-none transition">
